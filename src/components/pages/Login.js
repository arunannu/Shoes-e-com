...
const Login = () => {
  ...
  const onSubmitHandler=(e)=>{
    ...
    let url;
    if(isLogin){
      url= 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB0is-I8-meTJQ5RCmZiaZiMky5QzXW050';
    }
      else{
        url= 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB0is-I8-meTJQ5RCmZiaZiMky5QzXW050';
      }
      fetch(url ,{
        method:'POST',
        body: JSON.stringify({
